...
import { ArrowLeft, Layers, Paintbrush, Save, X } from "lucide-react";
  ...
  return (
    <div className="max-w-2xl mx-auto pb-48 md:pb-12 space-y-5 sm:space-y-6 animate-fade-in">
      ...
      <div className="space-y-6 sm:space-y-8">
        {/* Info Section */}
        <Section title={mode === "create" ? t.form.title_add : t.form.title_edit} icon={<Layers size={18} />}>
          <div className="space-y-5">
            ...
            <Field label={t.form.description_label}>
              <textarea
                ...
                disabled={isPending}
                dir="rtl"
                className="w-full px-4 py-3 bg-muted/20 border border-border/40 rounded-xl sm:rounded-2xl text-sm font-bold focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/30 transition-all resize-none placeholder:text-muted-foreground/40 disabled:opacity-50"
              />
            </Field>
          </div>
        </Section>
