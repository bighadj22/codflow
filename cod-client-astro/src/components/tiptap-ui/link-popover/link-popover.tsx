  ...
  ({ className, children, ...props }, ref) => {
    return (
      <Button
        ...
        role="button"
        tabIndex={-1}
        aria-label={editorT("editor.link")}
        tooltip={editorT("editor.link")}
        ref={ref}
        {...props}
      >
      ...
      >
        <CardItemGroup orientation="horizontal">
          <InputGroup>
            <Input
              type="url"
              placeholder={editorT("editor.link_placeholder")}
              value={url}
          ...
          <ButtonGroup orientation="horizontal">
            <Button
              type="button"
              onClick={setLink}
              title={editorT("editor.link_apply")}
          ...
          <ButtonGroup orientation="horizontal">
            <Button
              type="button"
              onClick={openLink}
              title={editorT("editor.link_open_new")}
              disabled={!url && !isActive}
              data-style="ghost"
            >
            ...
            <Button
              type="button"
              onClick={removeLink}
              title={editorT("editor.link_remove")}
              disabled={!url && !isActive}
              data-style="ghost"
            >
